 ...
 * Slug: athemeart/quick-promotions
 * Description: 
 * Categories: joyas-shop
 * Keywords: store, advertisement, shop, promotion, promotions
 * Viewport Width: 1280
 * Block Types: 
 * Post Types: 
 * Inserter: true
 * Custom Categories: Joyash Shop
 */
?>
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( '/assets/image/quick-patterns-1.webp' ) ); ?>","dimRatio":20,"overlayColor":"quaternary","focalPoint":{"x":0.5,"y":0},"minHeight":724,"contentPosition":"bottom left","isDark":false,"layout":{"type":"constrained"}} -->
<div class="wp-block-cover is-light has-custom-content-position is-position-bottom-left" style="min-height:724px"><span aria-hidden="true" class="wp-block-cover__background has-quaternary-background-color has-background-dim-20 has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( '/assets/image/quick-patterns-1.webp' ) ); ?>" style="object-position:50% 0%" data-object-fit="cover" data-object-position="50% 0%"/><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"blockGap":"0","padding":{"bottom":"var:preset|spacing|x-small","left":"var:preset|spacing|x-small"}}},"layout":{"type":"constrained"}} -->
...
<p class="has-text-align-left has-small-font-size"><?php esc_html_e( 'Fresh Designs of Our Spring Collection.', 'joyas-shop' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'New Arrivals', 'joyas-shop' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Shop Now', 'joyas-shop' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
...
<div class="wp-block-group" style="padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:paragraph {"align":"left","placeholder":"Write title…","fontSize":"small"} -->
<p class="has-text-align-left has-small-font-size"><?php esc_html_e( 'Comfort With Our latest Footwear Collection.', 'joyas-shop' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Footwear', 'joyas-shop' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( '/assets/image/quick-patterns-3.webp' ) ); ?>","dimRatio":20,"overlayColor":"quaternary","minHeight":350,"contentPosition":"bottom left","isDark":false,"style":{"spacing":{"blockGap":"var:preset|spacing|xx-small"}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group" style="padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:paragraph {"align":"left","placeholder":"Write title…","fontSize":"small"} -->
<p class="has-text-align-left has-small-font-size"><?php esc_html_e( 'Exclusive Selection of Imported', 'joyas-shop' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Perfumes', 'joyas-shop' ); ?></h2>
<!-- /wp:heading -->
